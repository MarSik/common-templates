...
metadata:
  ...
  annotations:
    ...
    # This set of annotations is meant as a hint only, it is
    # not going to be processed by the stock openshift templating
    # mechanism. CNV UI can and should use it though.
    # The information encoded here informs the tooling (UI)
